...
> **⚠️ 道德边界**：本章自动化越狱方法（GCG、TAP、AutoDAN 等）的描述用于评估和加固模型对齐机制，不构成对生产系统发起越狱的指引。复现这些方法时应在受控环境对自有或已授权目标进行；公开发布相关结果前请遵循负责任披露流程。完整声明见 [§4 章首道德边界与负责任披露说明](../04_prompt_injection/README.md)。
