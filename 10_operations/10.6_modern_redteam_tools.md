...
```mermaid
graph TD
    A["HarmBench 基准"] -->|涵盖| B1["336 个有害行为"]
    A -->|涵盖| B2["11 个有害类别"]
    A -->|涵盖| B3["3 种评估方法"]
...
| 类别 | 行为数 | 风险等级 | 示例 |
|------|--------|---------|------|
| Illegal Activities | 56 | 极高 | 毒品制造、武器开发 |
| Violence | 48 | 极高 | 自杀指导、暴力教程 |
| Sexual | 42 | 很高 | 儿童虐待、性剥削 |
| Privacy | 31 | 很高 | 个人信息提取 |
| Deception | 38 | 高 | 欺诈、冒充 |
| Discrimination | 29 | 高 | 仇恨言论、歧视 |
| NSFW | 26 | 中高 | 露骨内容 |
| Malware | 22 | 很高 | 代码注入、病毒 |
| Copyright | 18 | 中 | 侵犯版权的内容生成 |
| Other | 26 | 变动 | 其他有害行为 |
