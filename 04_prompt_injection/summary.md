...
本章深入剖析了提示注入攻击——LLM 面临的最主要威胁。从原理到实践，从直接注入到间接注入，全面展示了这一攻击类型的技术细节。
...
**真实案例**：Bing Chat 图片注入、Gemini 日历攻击、ChatGPT 代码解释器漏洞、企业 RAG 信息泄露、Copilot Reprompt 攻击等案例展示了提示注入的实际危害和多样化的攻击向量。
