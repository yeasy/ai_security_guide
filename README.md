...
- **紧跟前沿**：融入 2025-2026 年最新的安全研究成果与行业最佳实践
...
- **第一部分（第1-3章）** 建立基础认知，适合所有读者
- **第二部分（第4-7章）** 深入攻击技术，适合需要了解威胁的读者
- **第三部分（第8-11章）** 聚焦防御实践，适合需要构建安全系统的读者
- **第四部分（第12-13章）** 展望未来与资源汇总，适合持续学习者

对于时间有限的读者，可优先阅读第1章、第4章、第8章和第12章，快速建立整体认知。

---

## 作者说明

本书创作于 2026 年初，力求反映 LLM 安全领域的最新进展。由于该领域发展极为迅速，书中部分内容可能随着时间推移而需要更新。建议读者结合附录中的资源列表，持续关注该领域的最新动态。
