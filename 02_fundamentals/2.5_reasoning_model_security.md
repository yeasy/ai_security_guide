...
图 2-11：Extended Thinking 的安全隐患
...
#### 提示注入（Prompt Injection）vs 思维注入（Thought Injection）对比
...
图 2-14：Extended Thinking 的安全边界设置
