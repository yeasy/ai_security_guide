...
**OWASP LLM Top 10**：业界最权威的 LLM 安全风险清单，2025 年版本包括提示注入、敏感信息泄露、供应链风险、数据投毒、不当输出处理、过度自主权、系统提示泄露、向量与嵌入弱点、错误信息、无限制消耗等十大风险类别。

**NIST AI RMF**：美国 NIST 发布的 AI 风险管理框架，定义了可信 AI 的七项特征和四个核心功能（治理、映射、测量、管理），为系统化的 AI 风险管理提供了方法论。
