...
**MITRE ATLAS**：以攻击者视角组织的 AI 对抗战术与技术（TTP）矩阵，仿照 ATT&CK，并新增 ML Model Access、ML Attack Staging 等 AI 专属战术；它把 OWASP/NIST 的"风险"翻译成可演练、可检测的具体攻击技术，是"风险—治理—对抗"三视角中的对抗一环。
